...
def sample_perturbation(gt_pts, mean_shape):
    ...
    # compute rigid parameters by aligning reference shape with pts
    ...
    # perturb_scale, perturb_tx, perturb_ty = 0.1, 20, 20
    perturb_scale_small, perturb_tx_small, perturb_ty_small = 0.1, 10, 10
    # perturb_scale_small, perturb_tx_small, perturb_ty_small = 0.05, 5, 5
